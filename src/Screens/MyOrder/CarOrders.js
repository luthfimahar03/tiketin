                        ...
                        <CardItem header button >
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={{ flexDirection: "row" }}>
                                    <View style={{ flex: 1, marginLeft: -15 }}>
                                        ...
                                        <View style={{ flexDirection: "row", paddingHorizontal: 15, paddingVertical: 5 }}>
                                            <Text style={{ fontSize: 14 }}>Solo  </Text>
                                            <Icon
                                        ...
                                        <View style={{ paddingHorizontal: 15, paddingVertical: 5 }}>
                                            <Text style={{ fontSize: 14, color: "grey" }}>GRAND LIVINA</Text>
                                            <Text style={{ fontSize: 14, color: "grey", marginTop: 10 }}>{`\u2022 Max 6 Penumpang`}</Text>
                                        </View>
                                        <View style={{ flexDirection: "row", paddingHorizontal: 15, paddingVertical: 5 }}>
                                ...
                                <View style={{ marginVertical: 5 }}>
                                    <Card style={{ width: 100, alignItems: "center", borderWidth: 5, borderStyle: "dotted", backgroundColor: "#F6F7FC" }} >
                                        <Text style={{ paddingVertical: 10, color: "#2ecc71", fontWeight: "bold" }}>
                                            Finished
                                </Text>
                                    </Card>
                                </View>
